...
/// a High Scale SSD instance with a snapshot.
///
...
final class NetworkStack extends Stack {
  NetworkStack({required String projectId})
    ...
    // HIGH_SCALE_SSD tier supports snapshots (basic HDD tiers do not). Quota is
    // separate from the Enterprise ZONAL pool that terradart-validate lacks in
    // asia-northeast1.
    final snapshotNfs = add(
      GoogleFilestoreInstance(
        ...
        fileShares: FilestoreInstanceFileShare(
          ...
          // High Scale SSD minimum capacity is 10 TiB.
