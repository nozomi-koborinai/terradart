...
/// - a custom-mode VPC network (`main-vpc`) and a peer VPC (`peer-vpc`) with
///   bidirectional VPC peering,
/// - classic and HA VPN gateways with representative IPSec tunnels (including
///   an external VPN gateway peer),
/// - peering custom-route import/export policy on `main-to-peer`,
/// - a regional external IPv4 address for a load balancer (`lb-vip-prod`),
/// - a Cloud Router interface, BGP peer, Dedicated Interconnect + VLAN
///   attachment, and Cloud NAT for private egress,
///
