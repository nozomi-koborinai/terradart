...
import 'package:terradart_example_network_security_gateway_policy_quickstart/main.dart';
...
Future<void> main() async {
  ...
  final stack = NetworkSecurityGatewayPolicyStack(projectId: projectId);
