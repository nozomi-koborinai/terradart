...
├── lib/main.dart       # FleetStack (API enablement + scope + namespace + rollout sequence)
...
Fleet scopes, namespaces, and rollout sequences are free fleet-management resources; the stack creates and destroys cleanly in a single project.
