...
- [Pub/Sub topic + IAM member / binding / policy](examples/pubsub_quickstart/)
- [Cloud Tasks queue + IAM member](examples/cloud_tasks_quickstart/)
- [Secret Manager (write-only fields + secret IAM binding/policy)](examples/secret_manager_quickstart/)
