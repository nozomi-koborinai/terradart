...
**Pre-alpha** — no SemVer guarantees until v1.0.0. Pin `^0.19.x`, read [`MIGRATING.md`](MIGRATING.md) before bumping, and see [status on terradart.dev](https://terradart.dev/docs/status/).
...
# pubspec.yaml
dependencies:
  terradart_core: ^0.19.x
  terradart_google: ^0.19.x
```
