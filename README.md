...
[`terradart_google`](packages/terradart_google/README.md) ships **1093 curated resource factories + 1 data source** (1094 catalog entries) across per-service barrels (`compute`, `pubsub`, `cloud_run`, `bigquery`, …). Surfaces include Compute, GKE, BigQuery, Cloud Run, IAM, networking, and Vertex AI.
