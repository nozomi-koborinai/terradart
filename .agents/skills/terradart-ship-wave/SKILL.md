...
| New `*IamBinding` / `*IamPolicy`, sibling `*IamMember` already in synth | Prefer `tool/example_debt.yaml` + `iam-adjunct-debt:` (no example / apply-smoke) |
