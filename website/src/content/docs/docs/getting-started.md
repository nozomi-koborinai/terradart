...
This guide matches the [README quickstart](https://github.com/nozomi-koborinai/terradart#quickstart) for the **0.19.x** line. TerraDart is **pre-alpha** until [beta gates](/docs/status/#beta-readiness-checklist) are complete (planned label: **v0.17.0**).
