...
Pin dependencies with `^0.28.x` on [pub.dev](https://pub.dev/packages/terradart_core) today.

| Version | Status | Security fixes |
|---|---|---|
| **0.28.x** (alpha, current) | **Best-effort** | Yes, on a rolling basis — no embargo guarantees |
| **0.11.x and older** | Unsupported | Upgrade to 0.28.x; see [MIGRATING.md](MIGRATING.md) |
