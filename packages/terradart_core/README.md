...
- [`terradart_google`](https://pub.dev/packages/terradart_google) — 28 Tier 1 GCP factory wrappers + 1 data source, plus generated schema carriers.
...
`terradart_google` 0.1.0-dev uses this convention for every fixed-value-set field in its 28 Tier 1 resources.
