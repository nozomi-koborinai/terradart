...
/// Every generated manifest, in lookup precedence: a `google_*` type is
/// looked up in `terradart_google` before `terradart_google_beta`.
...
/// The manifest of [package] (`terradart_cloudflare`), or `null`.
