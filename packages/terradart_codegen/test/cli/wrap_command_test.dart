...
void main() {
  ...
  group('WrapCommand integration', () {
    test(
        'emits 311 files (309 resource Layer 2 + 1 data source Layer 2 + 1 generated _catalog.g.dart)',
        () async {
      ...
      try {
        ...
        // 310 wrappers (309 resource Layer 2 + 1 data source Layer 2) plus
        // the generated static catalog `_catalog.g.dart` (one CatalogEntry
        // per wrapper) → 311 emitted .dart files.
        expect(files, hasLength(311));
