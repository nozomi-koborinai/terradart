...
void main() {
  ...
  group('WrapCommand integration', () {
    test(
        'emits 1184 files (1067 wrappers + _catalog.g.dart + 115 barrels + umbrella)',
        () async {
      ...
      try {
        ...
        // 1067 wrappers (1066 resource Layer 2 + 1 data source Layer 2) plus
        // the generated static catalog `_catalog.g.dart`, plus the derived
        // barrels: 115 per-catalog barrels (114 service + `data`) and the
        // `terradart_google.dart` umbrella → 1184 emitted .dart files.
        expect(files, hasLength(1184));
