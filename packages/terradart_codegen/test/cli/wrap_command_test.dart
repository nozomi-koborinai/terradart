...
void main() {
  ...
  group('WrapCommand integration', () {
    test(
        'emits 973 files (862 wrappers + _catalog.g.dart + 109 barrels + umbrella)',
        () async {
      ...
      try {
        ...
        // 862 wrappers (861 resource Layer 2 + 1 data source Layer 2) plus
        // the generated static catalog `_catalog.g.dart`, plus the derived
        // barrels: 109 per-catalog barrels (108 service + `data`) and the
        // `terradart_google.dart` umbrella → 973 emitted .dart files.
        expect(files, hasLength(973));
