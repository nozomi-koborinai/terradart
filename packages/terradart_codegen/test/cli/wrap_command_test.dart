...
void main() {
  ...
  group('WrapCommand integration', () {
    test(
        'emits 215 files (213 resource Layer 2 + 1 data source Layer 2 + 1 generated _catalog.g.dart)',
        () async {
      ...
      try {
        ...
        // 214 wrappers (213 resource Layer 2 + 1 data source Layer 2) plus
        // the generated static catalog `_catalog.g.dart` (one CatalogEntry
        // per wrapper) → 215 emitted .dart files.
        expect(files, hasLength(215));
