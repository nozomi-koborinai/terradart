...
void main() {
  ...
  group('WrapCommand integration', () {
    test(
        'emits 310 files (308 resource Layer 2 + 1 data source Layer 2 + 1 generated _catalog.g.dart)',
        () async {
      ...
      try {
        ...
        // 309 wrappers (308 resource Layer 2 + 1 data source Layer 2) plus
        // the generated static catalog `_catalog.g.dart` (one CatalogEntry
        // per wrapper) → 310 emitted .dart files.
        expect(files, hasLength(310));
