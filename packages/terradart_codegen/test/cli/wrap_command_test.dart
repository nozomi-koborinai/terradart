...
void main() {
  ...
  group('WrapCommand integration', () {
    test(
        'emits 633 files (537 wrappers + _catalog.g.dart + 94 barrels + umbrella)',
        () async {
      ...
      try {
        ...
        // 537 wrappers (536 resource Layer 2 + 1 data source Layer 2) plus
        // the generated static catalog `_catalog.g.dart`, plus the derived
        // barrels: 92 per-catalog barrels (91 service + `data`) and the
        // `terradart_google.dart` umbrella → 633 emitted .dart files.
        expect(files, hasLength(633));
