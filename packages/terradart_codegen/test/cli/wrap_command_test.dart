...
void main() {
  ...
  group('WrapCommand integration', () {
    test(
        'emits 379 files (377 resource Layer 2 + 1 data source Layer 2 + 1 generated _catalog.g.dart)',
        () async {
      ...
      try {
        ...
        // 378 wrappers (377 resource Layer 2 + 1 data source Layer 2) plus
        // the generated static catalog `_catalog.g.dart` (one CatalogEntry
        // per wrapper) → 379 emitted .dart files.
        expect(files, hasLength(379));
