...
void main() {
  ...
  group('WrapCommand integration', () {
    test(
        'emits 195 files (193 resource Layer 2 + 1 data source Layer 2 + 1 generated _catalog.g.dart)',
        () async {
      ...
      try {
        ...
        // 194 wrappers (193 resource Layer 2 + 1 data source Layer 2) plus
        // the generated static catalog `_catalog.g.dart` (one CatalogEntry
        // per wrapper) → 195 emitted .dart files.
        expect(files, hasLength(195));
