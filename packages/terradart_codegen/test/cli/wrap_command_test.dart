...
void main() {
  ...
  group('WrapCommand integration', () {
    test(
        'emits 279 files (277 resource Layer 2 + 1 data source Layer 2 + 1 generated _catalog.g.dart)',
        () async {
      ...
      try {
        ...
        // 278 wrappers (277 resource Layer 2 + 1 data source Layer 2) plus
        // the generated static catalog `_catalog.g.dart` (one CatalogEntry
        // per wrapper) → 279 emitted .dart files.
        expect(files, hasLength(279));
