...
void main() {
  ...
  group('WrapCommand integration', () {
    test(
        'emits 501 files (428 wrappers + _catalog.g.dart + 71 barrels + umbrella)',
        () async {
      ...
      try {
        ...
        // 428 wrappers (427 resource Layer 2 + 1 data source Layer 2) plus
        // the generated static catalog `_catalog.g.dart`, plus the derived
        // barrels: 71 per-catalog barrels (70 service + `data`) and the
        // `terradart_google.dart` umbrella → 501 emitted .dart files.
        expect(files, hasLength(501));
