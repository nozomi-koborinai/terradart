...
void main() {
  ...
  group('WrapCommand integration', () {
    test(
        'emits 200 files (198 resource Layer 2 + 1 data source Layer 2 + 1 generated _catalog.g.dart)',
        () async {
      ...
      try {
        ...
        // 199 wrappers (198 resource Layer 2 + 1 data source Layer 2) plus
        // the generated static catalog `_catalog.g.dart` (one CatalogEntry
        // per wrapper) → 200 emitted .dart files.
