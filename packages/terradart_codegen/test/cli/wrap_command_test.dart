...
void main() {
  ...
  group('WrapCommand integration', () {
    test(
        'emits 248 files (246 resource Layer 2 + 1 data source Layer 2 + 1 generated _catalog.g.dart)',
        () async {
      ...
      try {
        ...
        // 247 wrappers (246 resource Layer 2 + 1 data source Layer 2) plus
        // the generated static catalog `_catalog.g.dart` (one CatalogEntry
        // per wrapper) → 248 emitted .dart files.
        expect(files, hasLength(248));
