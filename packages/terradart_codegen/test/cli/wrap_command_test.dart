...
void main() {
  ...
  group('WrapCommand integration', () {
    test(
        'emits 1277 files (1157 wrappers + _catalog.g.dart + 118 barrels + umbrella)',
        () async {
      ...
      try {
        ...
        // 1157 wrappers (1156 resource Layer 2 + 1 data source Layer 2) plus
        // the generated static catalog `_catalog.g.dart`, plus the derived
        // barrels: 118 per-catalog barrels (117 service + `data`) and the
        // `terradart_google.dart` umbrella → 1277 emitted .dart files.
        expect(files, hasLength(1277));
