...
void main() {
  ...
  group('WrapCommand integration', () {
    test(
        'emits 216 files (214 resource Layer 2 + 1 data source Layer 2 + 1 generated _catalog.g.dart)',
        () async {
      ...
      try {
        ...
        // 215 wrappers (214 resource Layer 2 + 1 data source Layer 2) plus
        // the generated static catalog `_catalog.g.dart` (one CatalogEntry
        // per wrapper) → 216 emitted .dart files.
        expect(files, hasLength(216));
