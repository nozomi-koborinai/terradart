...
void main() {
  ...
  group('WrapCommand integration', () {
    test(
        'emits 627 files (534 wrappers + _catalog.g.dart + 91 barrels + umbrella)',
        () async {
      ...
      try {
        ...
        // 534 wrappers (533 resource Layer 2 + 1 data source Layer 2) plus
        // the generated static catalog `_catalog.g.dart`, plus the derived
        // barrels: 89 per-catalog barrels (88 service + `data`) and the
        // `terradart_google.dart` umbrella → 627 emitted .dart files.
        expect(files, hasLength(627));
