...
void main() {
  ...
  group('WrapCommand integration', () {
    test(
        'emits 294 files (292 resource Layer 2 + 1 data source Layer 2 + 1 generated _catalog.g.dart)',
        () async {
      ...
      try {
        ...
        // 293 wrappers (292 resource Layer 2 + 1 data source Layer 2) plus
        // the generated static catalog `_catalog.g.dart` (one CatalogEntry
        // per wrapper) → 294 emitted .dart files.
        expect(files, hasLength(294));
