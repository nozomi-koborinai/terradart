...
void main() {
  ...
  group('WrapCommand integration', () {
    test(
        'emits 1052 files (938 wrappers + _catalog.g.dart + 112 barrels + umbrella)',
        () async {
      ...
      try {
        ...
        // 938 wrappers (937 resource Layer 2 + 1 data source Layer 2) plus
        // the generated static catalog `_catalog.g.dart`, plus the derived
        // barrels: 112 per-catalog barrels (111 service + `data`) and the
        // `terradart_google.dart` umbrella → 1052 emitted .dart files.
        expect(files, hasLength(1052));
