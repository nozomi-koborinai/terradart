...
void main() {
  ...
  group('WrapCommand integration', () {
    test(
        'emits 197 files (195 resource Layer 2 + 1 data source Layer 2 + 1 generated _catalog.g.dart)',
        () async {
      ...
      try {
        ...
        // 196 wrappers (195 resource Layer 2 + 1 data source Layer 2) plus
        // the generated static catalog `_catalog.g.dart` (one CatalogEntry
        // per wrapper) → 197 emitted .dart files.
        expect(files, hasLength(197));
