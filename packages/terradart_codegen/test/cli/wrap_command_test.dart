...
void main() {
  ...
  group('WrapCommand integration', () {
    test(
        'emits 286 files (284 resource Layer 2 + 1 data source Layer 2 + 1 generated _catalog.g.dart)',
        () async {
      ...
      try {
        ...
        // 285 wrappers (284 resource Layer 2 + 1 data source Layer 2) plus
        // the generated static catalog `_catalog.g.dart` (one CatalogEntry
        // per wrapper) → 286 emitted .dart files.
        expect(files, hasLength(286));
