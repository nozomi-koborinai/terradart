...
void main() {
  ...
  group('WrapCommand integration', () {
    test(
        'emits 192 files (190 resource Layer 2 + 1 data source Layer 2 + 1 generated _catalog.g.dart)',
        () async {
      ...
      try {
        ...
        // 191 wrappers (190 resource Layer 2 + 1 data source Layer 2) plus
        // the generated static catalog `_catalog.g.dart` (one CatalogEntry
        // per wrapper) → 192 emitted .dart files.
        expect(files, hasLength(192));
