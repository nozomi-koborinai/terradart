...
void main() {
  ...
  group('WrapCommand integration', () {
    test(
        'emits 201 files (199 resource Layer 2 + 1 data source Layer 2 + 1 generated _catalog.g.dart)',
        () async {
      ...
      try {
        ...
        // 200 wrappers (199 resource Layer 2 + 1 data source Layer 2) plus
        // the generated static catalog `_catalog.g.dart` (one CatalogEntry
        // per wrapper) → 201 emitted .dart files.
