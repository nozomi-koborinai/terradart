...
void main() {
  ...
  group('WrapCommand integration', () {
    test(
        'emits 298 files (296 resource Layer 2 + 1 data source Layer 2 + 1 generated _catalog.g.dart)',
        () async {
      ...
      try {
        ...
        // 297 wrappers (296 resource Layer 2 + 1 data source Layer 2) plus
        // the generated static catalog `_catalog.g.dart` (one CatalogEntry
        // per wrapper) → 298 emitted .dart files.
        expect(files, hasLength(298));
