...
void main() {
  ...
  group('WrapCommand integration', () {
    test(
        'emits 193 files (191 resource Layer 2 + 1 data source Layer 2 + 1 generated _catalog.g.dart)',
        () async {
      ...
      try {
        ...
        // 192 wrappers (191 resource Layer 2 + 1 data source Layer 2) plus
        // the generated static catalog `_catalog.g.dart` (one CatalogEntry
        // per wrapper) → 193 emitted .dart files.
        expect(files, hasLength(193));
