...
void main() {
  ...
  group('WrapCommand integration', () {
    test(
        'emits 149 files (147 resource Layer 2 + 1 data source Layer 2 + 1 generated _catalog.g.dart)',
        () async {
      ...
      try {
        ...
        // 148 wrappers (147 resource Layer 2 + 1 data source Layer 2) plus
        // the generated static catalog `_catalog.g.dart` (one CatalogEntry
        // per wrapper) → 149 emitted .dart files.
        expect(files, hasLength(149));
