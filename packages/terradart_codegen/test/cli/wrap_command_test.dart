...
void main() {
  ...
  group('WrapCommand integration', () {
    test(
        'emits 655 files (556 wrappers + _catalog.g.dart + 97 barrels + umbrella)',
        () async {
      ...
      try {
        ...
        // 556 wrappers (555 resource Layer 2 + 1 data source Layer 2) plus
        // the generated static catalog `_catalog.g.dart`, plus the derived
        // barrels: 97 per-catalog barrels (96 service + `data`) and the
        // `terradart_google.dart` umbrella → 655 emitted .dart files.
        expect(files, hasLength(655));
