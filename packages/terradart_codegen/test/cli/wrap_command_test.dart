...
void main() {
  ...
  group('WrapCommand integration', () {
    test(
        'emits 280 files (278 resource Layer 2 + 1 data source Layer 2 + 1 generated _catalog.g.dart)',
        () async {
      ...
      try {
        ...
        // 279 wrappers (278 resource Layer 2 + 1 data source Layer 2) plus
        // the generated static catalog `_catalog.g.dart` (one CatalogEntry
        // per wrapper) → 280 emitted .dart files.
        expect(files, hasLength(280));
