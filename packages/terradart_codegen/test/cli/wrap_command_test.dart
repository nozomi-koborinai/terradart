...
void main() {
  ...
  group('WrapCommand integration', () {
    test(
        'emits 183 files (181 resource Layer 2 + 1 data source Layer 2 + 1 generated _catalog.g.dart)',
        () async {
      ...
      try {
        ...
        // 182 wrappers (181 resource Layer 2 + 1 data source Layer 2) plus
        // the generated static catalog `_catalog.g.dart` (one CatalogEntry
        // per wrapper) → 183 emitted .dart files.
        expect(files, hasLength(183));
