...
void main() {
  ...
  group('WrapCommand integration', () {
    test(
        'emits 988 files (877 wrappers + _catalog.g.dart + 109 barrels + umbrella)',
        () async {
      ...
      try {
        ...
        // 877 wrappers (876 resource Layer 2 + 1 data source Layer 2) plus
        // the generated static catalog `_catalog.g.dart`, plus the derived
        // barrels: 109 per-catalog barrels (108 service + `data`) and the
        // `terradart_google.dart` umbrella → 988 emitted .dart files.
        expect(files, hasLength(988));
