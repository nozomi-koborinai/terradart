...
void main() {
  ...
  group('WrapCommand integration', () {
    test(
        'emits 247 files (245 resource Layer 2 + 1 data source Layer 2 + 1 generated _catalog.g.dart)',
        () async {
      ...
      try {
        ...
        // 246 wrappers (245 resource Layer 2 + 1 data source Layer 2) plus
        // the generated static catalog `_catalog.g.dart` (one CatalogEntry
        // per wrapper) → 247 emitted .dart files.
        expect(files, hasLength(247));
