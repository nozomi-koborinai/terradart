...
void main() {
  ...
  group('WrapCommand integration', () {
    test(
        'emits 1284 files (1163 wrappers + _catalog.g.dart + 119 barrels + umbrella)',
        () async {
      ...
      try {
        ...
        // 1163 wrappers (1162 resource Layer 2 + 1 data source Layer 2) plus
        // the generated static catalog `_catalog.g.dart`, plus the derived
        // barrels: 119 per-catalog barrels (118 service + `data`) and the
        // `terradart_google.dart` umbrella → 1284 emitted .dart files.
        expect(files, hasLength(1284));
