...
void main() {
  ...
  group('WrapCommand integration', () {
    test(
        'emits 1309 files (1183 wrappers + _catalog.g.dart + 124 barrels + umbrella)',
        () async {
      ...
      try {
        ...
        // 1183 wrappers (1182 resource Layer 2 + 1 data source Layer 2) plus
        // the generated static catalog `_catalog.g.dart`, plus the derived
        // barrels: 124 per-catalog barrels (123 service + `data`) and the
        // `terradart_google.dart` umbrella → 1309 emitted .dart files.
        expect(files, hasLength(1309));
