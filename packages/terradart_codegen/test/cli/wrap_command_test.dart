...
void main() {
  ...
  group('WrapCommand integration', () {
    test(
        'emits 588 files (499 wrappers + _catalog.g.dart + 87 barrels + umbrella)',
        () async {
      ...
      try {
        ...
        // 499 wrappers (498 resource Layer 2 + 1 data source Layer 2) plus
        // the generated static catalog `_catalog.g.dart`, plus the derived
        // barrels: 87 per-catalog barrels (86 service + `data`) and the
        // `terradart_google.dart` umbrella → 588 emitted .dart files.
        expect(files, hasLength(588));
