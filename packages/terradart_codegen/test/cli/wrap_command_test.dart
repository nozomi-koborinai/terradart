...
void main() {
  ...
  group('WrapCommand integration', () {
    test(
        'emits 264 files (262 resource Layer 2 + 1 data source Layer 2 + 1 generated _catalog.g.dart)',
        () async {
      ...
      try {
        ...
        // 263 wrappers (262 resource Layer 2 + 1 data source Layer 2) plus
        // the generated static catalog `_catalog.g.dart` (one CatalogEntry
        // per wrapper) → 264 emitted .dart files.
