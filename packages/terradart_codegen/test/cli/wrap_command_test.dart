...
void main() {
  ...
  group('WrapCommand integration', () {
    test(
        'emits 1000 files (888 wrappers + _catalog.g.dart + 110 barrels + umbrella)',
        () async {
      ...
      try {
        ...
        // 888 wrappers (887 resource Layer 2 + 1 data source Layer 2) plus
        // the generated static catalog `_catalog.g.dart`, plus the derived
        // barrels: 110 per-catalog barrels (109 service + `data`) and the
        // `terradart_google.dart` umbrella → 1000 emitted .dart files.
        expect(files, hasLength(1000));
