...
void main() {
  ...
  group('WrapCommand integration', () {
    test(
        'emits 244 files (242 resource Layer 2 + 1 data source Layer 2 + 1 generated _catalog.g.dart)',
        () async {
      ...
      try {
        ...
        // 243 wrappers (242 resource Layer 2 + 1 data source Layer 2) plus
        // the generated static catalog `_catalog.g.dart` (one CatalogEntry
        // per wrapper) → 244 emitted .dart files.
        expect(files, hasLength(244));
