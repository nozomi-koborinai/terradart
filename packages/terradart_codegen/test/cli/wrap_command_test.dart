...
void main() {
  ...
  group('WrapCommand integration', () {
    test(
        'emits 539 files (459 wrappers + _catalog.g.dart + 78 barrels + umbrella)',
        () async {
      ...
      try {
        ...
        // 459 wrappers (458 resource Layer 2 + 1 data source Layer 2) plus
        // the generated static catalog `_catalog.g.dart`, plus the derived
        // barrels: 78 per-catalog barrels (77 service + `data`) and the
        // `terradart_google.dart` umbrella → 539 emitted .dart files.
        expect(files, hasLength(539));
