...
void main() {
  ...
  group('WrapCommand integration', () {
    test(
        'emits 595 files (505 wrappers + _catalog.g.dart + 88 barrels + umbrella)',
        () async {
      ...
      try {
        ...
        // 505 wrappers (504 resource Layer 2 + 1 data source Layer 2) plus
        // the generated static catalog `_catalog.g.dart`, plus the derived
        // barrels: 88 per-catalog barrels (87 service + `data`) and the
        // `terradart_google.dart` umbrella → 595 emitted .dart files.
        expect(files, hasLength(595));
