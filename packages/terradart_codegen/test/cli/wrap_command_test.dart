...
void main() {
  ...
  group('WrapCommand integration', () {
    test(
        'emits 196 files (194 resource Layer 2 + 1 data source Layer 2 + 1 generated _catalog.g.dart)',
        () async {
      ...
      try {
        ...
        // 195 wrappers (194 resource Layer 2 + 1 data source Layer 2) plus
        // the generated static catalog `_catalog.g.dart` (one CatalogEntry
        // per wrapper) → 196 emitted .dart files.
        expect(files, hasLength(196));
