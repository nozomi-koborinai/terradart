...
void main() {
  ...
  group('WrapCommand integration', () {
    test(
        'emits 885 files (774 wrappers + _catalog.g.dart + 109 barrels + umbrella)',
        () async {
      ...
      try {
        ...
        // 774 wrappers (773 resource Layer 2 + 1 data source Layer 2) plus
        // the generated static catalog `_catalog.g.dart`, plus the derived
        // barrels: 109 per-catalog barrels (108 service + `data`) and the
        // `terradart_google.dart` umbrella → 885 emitted .dart files.
        expect(files, hasLength(885));
