...
void main() {
  ...
  group('WrapCommand integration', () {
    test(
        'emits 611 files (519 wrappers + _catalog.g.dart + 90 barrels + umbrella)',
        () async {
      ...
      try {
        ...
        // 519 wrappers (518 resource Layer 2 + 1 data source Layer 2) plus
        // the generated static catalog `_catalog.g.dart`, plus the derived
        // barrels: 88 per-catalog barrels (87 service + `data`) and the
        // `terradart_google.dart` umbrella → 611 emitted .dart files.
        expect(files, hasLength(611));
