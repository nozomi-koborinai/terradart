...
void main() {
  ...
  group('WrapCommand integration', () {
    test(
        'emits 707 files (602 wrappers + _catalog.g.dart + 103 barrels + umbrella)',
        () async {
      ...
      try {
        ...
        // 602 wrappers (601 resource Layer 2 + 1 data source Layer 2) plus
        // the generated static catalog `_catalog.g.dart`, plus the derived
        // barrels: 103 per-catalog barrels (102 service + `data`) and the
        // `terradart_google.dart` umbrella → 707 emitted .dart files.
        expect(files, hasLength(707));
