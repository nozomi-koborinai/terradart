...
void main() {
  ...
  group('WrapCommand integration', () {
    test(
        'emits 305 files (303 resource Layer 2 + 1 data source Layer 2 + 1 generated _catalog.g.dart)',
        () async {
      ...
      try {
        ...
        // 304 wrappers (303 resource Layer 2 + 1 data source Layer 2) plus
        // the generated static catalog `_catalog.g.dart` (one CatalogEntry
        // per wrapper) → 305 emitted .dart files.
        expect(files, hasLength(305));
