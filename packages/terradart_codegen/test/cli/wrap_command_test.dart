...
void main() {
  ...
  group('WrapCommand integration', () {
    test(
        'emits 1315 files (1189 wrappers + _catalog.g.dart + 124 barrels + umbrella)',
        () async {
      ...
      try {
        ...
        // 1189 wrappers (1188 resource Layer 2 + 1 data source Layer 2) plus
        // the generated static catalog `_catalog.g.dart`, plus the derived
        // barrels: 124 per-catalog barrels (123 service + `data`) and the
        // `terradart_google.dart` umbrella → 1315 emitted .dart files.
        expect(files, hasLength(1315));
