...
void main() {
  ...
  group('WrapCommand integration', () {
    test(
        'emits 307 files (305 resource Layer 2 + 1 data source Layer 2 + 1 generated _catalog.g.dart)',
        () async {
      ...
      try {
        ...
        // 306 wrappers (305 resource Layer 2 + 1 data source Layer 2) plus
        // the generated static catalog `_catalog.g.dart` (one CatalogEntry
        // per wrapper) → 307 emitted .dart files.
        expect(files, hasLength(307));
