...
void main() {
  ...
  group('WrapCommand integration', () {
    test(
        'emits 133 files (131 resource Layer 2 + 1 data source Layer 2 + 1 generated _catalog.g.dart)',
        () async {
      ...
      try {
        ...
        // 132 wrappers (131 resource Layer 2 + 1 data source Layer 2) plus
        // the generated static catalog `_catalog.g.dart` (one CatalogEntry
        // per wrapper) → 133 emitted .dart files.
        expect(files, hasLength(133));
