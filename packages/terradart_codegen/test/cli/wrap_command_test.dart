...
void main() {
  ...
  group('WrapCommand integration', () {
    test(
        'emits 689 files (584 wrappers + _catalog.g.dart + 103 barrels + umbrella)',
        () async {
      ...
      try {
        ...
        // 584 wrappers (583 resource Layer 2 + 1 data source Layer 2) plus
        // the generated static catalog `_catalog.g.dart`, plus the derived
        // barrels: 103 per-catalog barrels (102 service + `data`) and the
        // `terradart_google.dart` umbrella → 689 emitted .dart files.
        expect(files, hasLength(689));
