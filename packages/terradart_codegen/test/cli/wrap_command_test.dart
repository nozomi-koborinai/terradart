...
void main() {
  ...
  group('WrapCommand integration', () {
    test(
        'emits 814 files (704 wrappers + _catalog.g.dart + 108 barrels + umbrella)',
        () async {
      ...
      try {
        ...
        // 704 wrappers (703 resource Layer 2 + 1 data source Layer 2) plus
        // the generated static catalog `_catalog.g.dart`, plus the derived
        // barrels: 108 per-catalog barrels (107 service + `data`) and the
        // `terradart_google.dart` umbrella → 814 emitted .dart files.
        expect(files, hasLength(814));
