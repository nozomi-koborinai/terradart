...
void main() {
  ...
  group('WrapCommand integration', () {
    test(
        'emits 300 files (298 resource Layer 2 + 1 data source Layer 2 + 1 generated _catalog.g.dart)',
        () async {
      ...
      try {
        ...
        // 299 wrappers (298 resource Layer 2 + 1 data source Layer 2) plus
        // the generated static catalog `_catalog.g.dart` (one CatalogEntry
        // per wrapper) → 300 emitted .dart files.
        expect(files, hasLength(300));
