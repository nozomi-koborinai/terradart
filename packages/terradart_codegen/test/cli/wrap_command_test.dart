...
void main() {
  ...
  group('WrapCommand integration', () {
    test(
        'emits 208 files (206 resource Layer 2 + 1 data source Layer 2 + 1 generated _catalog.g.dart)',
        () async {
      ...
      try {
        ...
        // 207 wrappers (206 resource Layer 2 + 1 data source Layer 2) plus
        // the generated static catalog `_catalog.g.dart` (one CatalogEntry
        // per wrapper) → 208 emitted .dart files.
        expect(files, hasLength(208));
