...
void main() {
  ...
  group('WrapCommand integration', () {
    test(
        'emits 228 files (226 resource Layer 2 + 1 data source Layer 2 + 1 generated _catalog.g.dart)',
        () async {
      ...
      try {
        ...
        // 227 wrappers (226 resource Layer 2 + 1 data source Layer 2) plus
        // the generated static catalog `_catalog.g.dart` (one CatalogEntry
        // per wrapper) → 226 emitted .dart files.
        expect(files, hasLength(228));
