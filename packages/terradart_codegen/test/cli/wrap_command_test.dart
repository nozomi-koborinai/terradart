...
void main() {
  ...
  group('WrapCommand integration', () {
    test(
        'emits 634 files (538 wrappers + _catalog.g.dart + 94 barrels + umbrella)',
        () async {
      ...
      try {
        ...
        // 538 wrappers (537 resource Layer 2 + 1 data source Layer 2) plus
        // the generated static catalog `_catalog.g.dart`, plus the derived
        // barrels: 92 per-catalog barrels (91 service + `data`) and the
        // `terradart_google.dart` umbrella → 634 emitted .dart files.
        expect(files, hasLength(634));
