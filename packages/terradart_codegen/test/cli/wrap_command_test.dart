...
void main() {
  ...
  group('WrapCommand integration', () {
    test(
        'emits 947 files (836 wrappers + _catalog.g.dart + 109 barrels + umbrella)',
        () async {
      ...
      try {
        ...
        // 836 wrappers (835 resource Layer 2 + 1 data source Layer 2) plus
        // the generated static catalog `_catalog.g.dart`, plus the derived
        // barrels: 109 per-catalog barrels (108 service + `data`) and the
        // `terradart_google.dart` umbrella → 947 emitted .dart files.
        expect(files, hasLength(947));
