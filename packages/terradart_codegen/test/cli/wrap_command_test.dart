...
void main() {
  ...
  group('WrapCommand integration', () {
    test(
        'emits 299 files (297 resource Layer 2 + 1 data source Layer 2 + 1 generated _catalog.g.dart)',
        () async {
      ...
      try {
        ...
        // 298 wrappers (297 resource Layer 2 + 1 data source Layer 2) plus
        // the generated static catalog `_catalog.g.dart` (one CatalogEntry
        // per wrapper) → 299 emitted .dart files.
        expect(files, hasLength(299));
