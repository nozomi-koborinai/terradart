...
void main() {
  ...
  group('WrapCommand integration', () {
    test(
        'emits 282 files (280 resource Layer 2 + 1 data source Layer 2 + 1 generated _catalog.g.dart)',
        () async {
      ...
      try {
        ...
        // 281 wrappers (280 resource Layer 2 + 1 data source Layer 2) plus
        // the generated static catalog `_catalog.g.dart` (one CatalogEntry
        // per wrapper) → 282 emitted .dart files.
        expect(files, hasLength(282));
