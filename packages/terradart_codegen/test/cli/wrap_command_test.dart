...
void main() {
  ...
  group('WrapCommand integration', () {
    test(
        'emits 512 files (437 wrappers + _catalog.g.dart + 73 barrels + umbrella)',
        () async {
      ...
      try {
        ...
        // 437 wrappers (436 resource Layer 2 + 1 data source Layer 2) plus
        // the generated static catalog `_catalog.g.dart`, plus the derived
        // barrels: 73 per-catalog barrels (72 service + `data`) and the
        // `terradart_google.dart` umbrella → 512 emitted .dart files.
        expect(files, hasLength(512));
