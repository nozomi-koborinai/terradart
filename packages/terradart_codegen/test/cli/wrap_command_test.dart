...
void main() {
  ...
  group('WrapCommand integration', () {
    test(
        'emits 683 files (579 wrappers + _catalog.g.dart + 102 barrels + umbrella)',
        () async {
      ...
      try {
        ...
        // 579 wrappers (578 resource Layer 2 + 1 data source Layer 2) plus
        // the generated static catalog `_catalog.g.dart`, plus the derived
        // barrels: 102 per-catalog barrels (101 service + `data`) and the
        // `terradart_google.dart` umbrella → 683 emitted .dart files.
        expect(files, hasLength(683));
