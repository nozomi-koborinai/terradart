...
void main() {
  ...
  group('WrapCommand integration', () {
    test(
        'emits 639 files (542 wrappers + _catalog.g.dart + 95 barrels + umbrella)',
        () async {
      ...
      try {
        ...
        // 542 wrappers (541 resource Layer 2 + 1 data source Layer 2) plus
        // the generated static catalog `_catalog.g.dart`, plus the derived
        // barrels: 95 per-catalog barrels (94 service + `data`) and the
        // `terradart_google.dart` umbrella → 639 emitted .dart files.
        expect(files, hasLength(639));
