...
void main() {
  ...
  group('WrapCommand integration', () {
    test(
        'emits 229 files (227 resource Layer 2 + 1 data source Layer 2 + 1 generated _catalog.g.dart)',
        () async {
