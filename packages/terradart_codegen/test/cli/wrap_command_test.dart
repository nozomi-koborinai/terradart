...
void main() {
  ...
  group('WrapCommand integration', () {
    test(
        'emits 1100 files (986 wrappers + _catalog.g.dart + 112 barrels + umbrella)',
        () async {
      ...
      try {
        ...
        // 986 wrappers (985 resource Layer 2 + 1 data source Layer 2) plus
        // the generated static catalog `_catalog.g.dart`, plus the derived
        // barrels: 112 per-catalog barrels (111 service + `data`) and the
        // `terradart_google.dart` umbrella → 1100 emitted .dart files.
        expect(files, hasLength(1100));
