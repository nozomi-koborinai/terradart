...
void main() {
  ...
  group('WrapCommand integration', () {
    test(
        'emits 1245 files (1126 wrappers + _catalog.g.dart + 117 barrels + umbrella)',
        () async {
      ...
      try {
        ...
        // 1126 wrappers (1125 resource Layer 2 + 1 data source Layer 2) plus
        // the generated static catalog `_catalog.g.dart`, plus the derived
        // barrels: 117 per-catalog barrels (116 service + `data`) and the
        // `terradart_google.dart` umbrella → 1245 emitted .dart files.
        expect(files, hasLength(1245));
