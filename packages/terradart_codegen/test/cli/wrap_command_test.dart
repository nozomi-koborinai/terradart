...
void main() {
  ...
  group('WrapCommand integration', () {
    test(
        'emits 220 files (218 resource Layer 2 + 1 data source Layer 2 + 1 generated _catalog.g.dart)',
        () async {
      ...
      try {
        ...
        // 219 wrappers (218 resource Layer 2 + 1 data source Layer 2) plus
        // the generated static catalog `_catalog.g.dart` (one CatalogEntry
        // per wrapper) → 220 emitted .dart files.
        expect(files, hasLength(220));
