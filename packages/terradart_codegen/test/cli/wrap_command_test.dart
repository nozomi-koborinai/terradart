...
void main() {
  ...
  group('WrapCommand integration', () {
    test(
        'emits 600 files (509 wrappers + _catalog.g.dart + 89 barrels + umbrella)',
        () async {
