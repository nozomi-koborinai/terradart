...
void main() {
  ...
  group('WrapCommand integration', () {
    test(
        'emits 224 files (222 resource Layer 2 + 1 data source Layer 2 + 1 generated _catalog.g.dart)',
        () async {
      ...
      try {
        ...
        // 223 wrappers (222 resource Layer 2 + 1 data source Layer 2) plus
        // the generated static catalog `_catalog.g.dart` (one CatalogEntry
        // per wrapper) → 224 emitted .dart files.
        expect(files, hasLength(224));
