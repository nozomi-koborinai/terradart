...
void main() {
  ...
  group('WrapCommand integration', () {
    test(
        'emits 580 files (492 wrappers + _catalog.g.dart + 86 barrels + umbrella)',
        () async {
      ...
      try {
        ...
        // 492 wrappers (491 resource Layer 2 + 1 data source Layer 2) plus
        // the generated static catalog `_catalog.g.dart`, plus the derived
        // barrels: 86 per-catalog barrels (85 service + `data`) and the
        // `terradart_google.dart` umbrella → 580 emitted .dart files.
        expect(files, hasLength(580));
