...
void main() {
  ...
  group('WrapCommand integration', () {
    test(
        'emits 515 files (439 wrappers + _catalog.g.dart + 74 barrels + umbrella)',
        () async {
      ...
      try {
        ...
        // 439 wrappers (438 resource Layer 2 + 1 data source Layer 2) plus
        // the generated static catalog `_catalog.g.dart`, plus the derived
        // barrels: 74 per-catalog barrels (73 service + `data`) and the
        // `terradart_google.dart` umbrella → 515 emitted .dart files.
        expect(files, hasLength(515));
