...
void main() {
  ...
  group('WrapCommand integration', () {
    test(
        'emits 1079 files (965 wrappers + _catalog.g.dart + 112 barrels + umbrella)',
        () async {
      ...
      try {
        ...
        // 965 wrappers (964 resource Layer 2 + 1 data source Layer 2) plus
        // the generated static catalog `_catalog.g.dart`, plus the derived
        // barrels: 112 per-catalog barrels (111 service + `data`) and the
        // `terradart_google.dart` umbrella → 1079 emitted .dart files.
        expect(files, hasLength(1079));
