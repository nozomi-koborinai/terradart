...
void main() {
  ...
  group('WrapCommand integration', () {
    test(
        'emits 322 files (320 resource Layer 2 + 1 data source Layer 2 + 1 generated _catalog.g.dart)',
        () async {
      ...
      try {
        ...
        // 321 wrappers (320 resource Layer 2 + 1 data source Layer 2) plus
        // the generated static catalog `_catalog.g.dart` (one CatalogEntry
        // per wrapper) → 322 emitted .dart files.
        expect(files, hasLength(322));
