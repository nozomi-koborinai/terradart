...
void main() {
  ...
  group('WrapCommand integration', () {
    test(
        'emits 529 files (451 wrappers + _catalog.g.dart + 76 barrels + umbrella)',
        () async {
      ...
      try {
        ...
        // 451 wrappers (450 resource Layer 2 + 1 data source Layer 2) plus
        // the generated static catalog `_catalog.g.dart`, plus the derived
        // barrels: 76 per-catalog barrels (75 service + `data`) and the
        // `terradart_google.dart` umbrella → 529 emitted .dart files.
        expect(files, hasLength(529));
