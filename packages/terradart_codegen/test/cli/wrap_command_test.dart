...
void main() {
  ...
  group('WrapCommand integration', () {
    test(
        'emits 188 files (186 resource Layer 2 + 1 data source Layer 2 + 1 generated _catalog.g.dart)',
        () async {
      ...
      try {
        ...
        // 187 wrappers (186 resource Layer 2 + 1 data source Layer 2) plus
        // the generated static catalog `_catalog.g.dart` (one CatalogEntry
        // per wrapper) → 188 emitted .dart files.
        expect(files, hasLength(188));
