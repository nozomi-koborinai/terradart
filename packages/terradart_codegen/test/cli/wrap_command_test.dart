...
void main() {
  ...
  group('WrapCommand integration', () {
    test(
        'emits 353 files (351 resource Layer 2 + 1 data source Layer 2 + 1 generated _catalog.g.dart)',
        () async {
      ...
      try {
        ...
        // 324 wrappers (323 resource Layer 2 + 1 data source Layer 2) plus
        // the generated static catalog `_catalog.g.dart` (one CatalogEntry
        // per wrapper) → 353 emitted .dart files.
        expect(files, hasLength(353));
