...
void main() {
  ...
  group('WrapCommand integration', () {
    test(
        'emits 991 files (880 wrappers + _catalog.g.dart + 109 barrels + umbrella)',
        () async {
      ...
      try {
        ...
        // 880 wrappers (879 resource Layer 2 + 1 data source Layer 2) plus
        // the generated static catalog `_catalog.g.dart`, plus the derived
        // barrels: 109 per-catalog barrels (108 service + `data`) and the
        // `terradart_google.dart` umbrella → 991 emitted .dart files.
        expect(files, hasLength(991));
