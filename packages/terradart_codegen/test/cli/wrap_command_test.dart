...
void main() {
  ...
  group('WrapCommand integration', () {
    test(
        'emits 258 files (256 resource Layer 2 + 1 data source Layer 2 + 1 generated _catalog.g.dart)',
        () async {
      ...
      try {
        ...
        // 257 wrappers (256 resource Layer 2 + 1 data source Layer 2) plus
        // the generated static catalog `_catalog.g.dart` (one CatalogEntry
        // per wrapper) → 258 emitted .dart files.
        expect(files, hasLength(258));
