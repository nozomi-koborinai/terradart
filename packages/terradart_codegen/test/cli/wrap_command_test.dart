...
void main() {
  ...
  group('WrapCommand integration', () {
    test(
        'emits 496 files (424 wrappers + _catalog.g.dart + 70 barrels + umbrella)',
        () async {
      ...
      try {
        ...
        // 424 wrappers (423 resource Layer 2 + 1 data source Layer 2) plus
        // the generated static catalog `_catalog.g.dart`, plus the derived
        // barrels: 70 per-catalog barrels (69 service + `data`) and the
        // `terradart_google.dart` umbrella → 496 emitted .dart files.
        expect(files, hasLength(496));
