...
void main() {
  ...
  group('WrapCommand integration', () {
    test(
        'emits 198 files (196 resource Layer 2 + 1 data source Layer 2 + 1 generated _catalog.g.dart)',
        () async {
      ...
      try {
        ...
        // 197 wrappers (196 resource Layer 2 + 1 data source Layer 2) plus
        // the generated static catalog `_catalog.g.dart` (one CatalogEntry
        // per wrapper) → 198 emitted .dart files.
        expect(files, hasLength(198));
