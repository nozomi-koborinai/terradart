...
void main() {
  ...
  group('WrapCommand integration', () {
    test(
        'emits 1299 files (1174 wrappers + _catalog.g.dart + 123 barrels + umbrella)',
        () async {
      ...
      try {
        ...
        // 1174 wrappers (1173 resource Layer 2 + 1 data source Layer 2) plus
        // the generated static catalog `_catalog.g.dart`, plus the derived
        // barrels: 123 per-catalog barrels (122 service + `data`) and the
        // `terradart_google.dart` umbrella → 1299 emitted .dart files.
        expect(files, hasLength(1299));
