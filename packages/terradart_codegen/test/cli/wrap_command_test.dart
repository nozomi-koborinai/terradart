...
void main() {
  ...
  group('WrapCommand integration', () {
    test(
        'emits 1310 files (1184 wrappers + _catalog.g.dart + 124 barrels + umbrella)',
        () async {
      ...
      try {
        ...
        // 1184 wrappers (1183 resource Layer 2 + 1 data source Layer 2) plus
        // the generated static catalog `_catalog.g.dart`, plus the derived
        // barrels: 124 per-catalog barrels (123 service + `data`) and the
        // `terradart_google.dart` umbrella → 1310 emitted .dart files.
        expect(files, hasLength(1310));
