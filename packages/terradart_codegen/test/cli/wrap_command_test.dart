...
void main() {
  ...
  group('WrapCommand integration', () {
    test(
        'emits 357 files (355 resource Layer 2 + 1 data source Layer 2 + 1 generated _catalog.g.dart)',
        () async {
      ...
      try {
        ...
        // 356 wrappers (355 resource Layer 2 + 1 data source Layer 2) plus
        // the generated static catalog `_catalog.g.dart` (one CatalogEntry
        // per wrapper) → 357 emitted .dart files.
        expect(files, hasLength(357));
