...
void main() {
  ...
  group('WrapCommand integration', () {
    test(
        'emits 252 files (250 resource Layer 2 + 1 data source Layer 2 + 1 generated _catalog.g.dart)',
        () async {
      ...
      try {
        ...
        // 251 wrappers (250 resource Layer 2 + 1 data source Layer 2) plus
        // the generated static catalog `_catalog.g.dart` (one CatalogEntry
        // per wrapper) → 252 emitted .dart files.
        expect(files, hasLength(252));
