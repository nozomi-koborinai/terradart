...
void main() {
  ...
  group('WrapCommand integration', () {
    test(
        'emits 471 files (400 wrappers + _catalog.g.dart + 68 barrels + umbrella)',
        () async {
      ...
      try {
        ...
        // 401 wrappers (400 resource Layer 2 + 1 data source Layer 2) plus
        // the generated static catalog `_catalog.g.dart`, plus the derived
        // barrels: 68 per-catalog barrels (67 service + `data`) and the
        // `terradart_google.dart` umbrella → 471 emitted .dart files.
        expect(files, hasLength(471));
