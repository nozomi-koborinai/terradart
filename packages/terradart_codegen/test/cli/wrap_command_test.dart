...
void main() {
  ...
  group('WrapCommand integration', () {
    test(
        'emits 359 files (357 resource Layer 2 + 1 data source Layer 2 + 1 generated _catalog.g.dart)',
        () async {
      ...
      try {
        ...
        // 358 wrappers (357 resource Layer 2 + 1 data source Layer 2) plus
        // the generated static catalog `_catalog.g.dart` (one CatalogEntry
        // per wrapper) → 359 emitted .dart files.
        expect(files, hasLength(359));
