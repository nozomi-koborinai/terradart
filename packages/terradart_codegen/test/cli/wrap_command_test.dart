...
void main() {
  ...
  group('WrapCommand integration', () {
    test(
        'emits 659 files (559 wrappers + _catalog.g.dart + 98 barrels + umbrella)',
        () async {
      ...
      try {
        ...
        // 559 wrappers (558 resource Layer 2 + 1 data source Layer 2) plus
        // the generated static catalog `_catalog.g.dart`, plus the derived
        // barrels: 97 per-catalog barrels (96 service + `data`) and the
        // `terradart_google.dart` umbrella → 659 emitted .dart files.
        expect(files, hasLength(659));
