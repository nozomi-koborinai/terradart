...
void main() {
  ...
  group('WrapCommand integration', () {
    test(
        'emits 610 files (518 wrappers + _catalog.g.dart + 90 barrels + umbrella)',
        () async {
      ...
      try {
        ...
        // 518 wrappers (517 resource Layer 2 + 1 data source Layer 2) plus
        // the generated static catalog `_catalog.g.dart`, plus the derived
        // barrels: 88 per-catalog barrels (87 service + `data`) and the
        // `terradart_google.dart` umbrella → 610 emitted .dart files.
        expect(files, hasLength(610));
