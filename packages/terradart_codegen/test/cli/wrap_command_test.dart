...
void main() {
  ...
  group('WrapCommand integration', () {
    test(
        'emits 995 files (883 wrappers + _catalog.g.dart + 110 barrels + umbrella)',
        () async {
      ...
      try {
        ...
        // 883 wrappers (882 resource Layer 2 + 1 data source Layer 2) plus
        // the generated static catalog `_catalog.g.dart`, plus the derived
        // barrels: 110 per-catalog barrels (109 service + `data`) and the
        // `terradart_google.dart` umbrella → 995 emitted .dart files.
        expect(files, hasLength(995));
