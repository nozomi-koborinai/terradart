...
void main() {
  ...
  group('WrapCommand integration', () {
    test(
        'emits 231 files (229 resource Layer 2 + 1 data source Layer 2 + 1 generated _catalog.g.dart)',
        () async {
      ...
      try {
        ...
        // 230 wrappers (229 resource Layer 2 + 1 data source Layer 2) plus
        // the generated static catalog `_catalog.g.dart` (one CatalogEntry
        // per wrapper) → 231 emitted .dart files.
        expect(files, hasLength(231));
