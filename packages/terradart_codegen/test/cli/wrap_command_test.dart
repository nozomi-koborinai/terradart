...
void main() {
  ...
  group('WrapCommand integration', () {
    test(
        'emits 527 files (450 wrappers + _catalog.g.dart + 75 barrels + umbrella)',
        () async {
      ...
      try {
        ...
        // 450 wrappers (449 resource Layer 2 + 1 data source Layer 2) plus
        // the generated static catalog `_catalog.g.dart`, plus the derived
        // barrels: 75 per-catalog barrels (74 service + `data`) and the
        // `terradart_google.dart` umbrella → 527 emitted .dart files.
        expect(files, hasLength(527));
