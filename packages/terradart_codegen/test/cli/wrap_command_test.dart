...
void main() {
  ...
  group('WrapCommand integration', () {
    test(
        'emits 123 files (121 resource Layer 2 + 1 data source Layer 2 + 1 generated _catalog.g.dart)',
        () async {
      ...
      try {
        ...
        // 122 wrappers (121 resource Layer 2 + 1 data source Layer 2) plus
        // the generated static catalog `_catalog.g.dart` (one CatalogEntry
        // per wrapper) → 123 emitted .dart files.
        expect(files, hasLength(123));
