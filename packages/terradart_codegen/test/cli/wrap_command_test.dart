...
void main() {
  ...
  group('WrapCommand integration', () {
    test(
        'emits 285 files (283 resource Layer 2 + 1 data source Layer 2 + 1 generated _catalog.g.dart)',
        () async {
      ...
      try {
        ...
        // 284 wrappers (283 resource Layer 2 + 1 data source Layer 2) plus
        // the generated static catalog `_catalog.g.dart` (one CatalogEntry
        // per wrapper) → 285 emitted .dart files.
        expect(files, hasLength(285));
