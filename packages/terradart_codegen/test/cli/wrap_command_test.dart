...
void main() {
  ...
  group('WrapCommand integration', () {
    test(
        'emits 813 files (703 wrappers + _catalog.g.dart + 108 barrels + umbrella)',
        () async {
      ...
      try {
        ...
        // 703 wrappers (702 resource Layer 2 + 1 data source Layer 2) plus
        // the generated static catalog `_catalog.g.dart`, plus the derived
        // barrels: 108 per-catalog barrels (107 service + `data`) and the
        // `terradart_google.dart` umbrella → 813 emitted .dart files.
        expect(files, hasLength(813));
