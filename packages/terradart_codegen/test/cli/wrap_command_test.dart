...
void main() {
  ...
  group('WrapCommand integration', () {
    test(
        'emits 1231 files (1112 wrappers + _catalog.g.dart + 117 barrels + umbrella)',
        () async {
      ...
      try {
        ...
        // 1112 wrappers (1111 resource Layer 2 + 1 data source Layer 2) plus
        // the generated static catalog `_catalog.g.dart`, plus the derived
        // barrels: 117 per-catalog barrels (116 service + `data`) and the
        // `terradart_google.dart` umbrella → 1231 emitted .dart files.
        expect(files, hasLength(1231));
