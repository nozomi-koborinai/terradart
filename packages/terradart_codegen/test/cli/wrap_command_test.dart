...
void main() {
  ...
  group('WrapCommand integration', () {
    test(
        'emits 312 files (310 resource Layer 2 + 1 data source Layer 2 + 1 generated _catalog.g.dart)',
        () async {
      ...
      try {
        ...
        // 311 wrappers (310 resource Layer 2 + 1 data source Layer 2) plus
        // the generated static catalog `_catalog.g.dart` (one CatalogEntry
        // per wrapper) → 312 emitted .dart files.
        expect(files, hasLength(312));
