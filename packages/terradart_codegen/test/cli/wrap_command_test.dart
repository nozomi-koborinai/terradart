...
void main() {
  ...
  group('WrapCommand integration', () {
    test(
        'emits 189 files (187 resource Layer 2 + 1 data source Layer 2 + 1 generated _catalog.g.dart)',
        () async {
      ...
      try {
        ...
        // 188 wrappers (187 resource Layer 2 + 1 data source Layer 2) plus
        // the generated static catalog `_catalog.g.dart` (one CatalogEntry
        // per wrapper) → 189 emitted .dart files.
        expect(files, hasLength(189));
