...
void main() {
  ...
  group('WrapCommand integration', () {
    test(
        'emits 269 files (267 resource Layer 2 + 1 data source Layer 2 + 1 generated _catalog.g.dart)',
        () async {
      ...
      try {
        ...
        // 268 wrappers (267 resource Layer 2 + 1 data source Layer 2) plus
        // the generated static catalog `_catalog.g.dart` (one CatalogEntry
        // per wrapper) → 269 emitted .dart files.
        expect(files, hasLength(269));
