...
void main() {
  ...
  group('WrapCommand integration', () {
    test(
        'emits 460 files (391 wrappers + _catalog.g.dart + 66 barrels + umbrella)',
        () async {
      ...
      try {
        ...
        // 392 wrappers (391 resource Layer 2 + 1 data source Layer 2) plus
