...
void main() {
  ...
  group('WrapCommand integration', () {
    test(
        'emits 218 files (216 resource Layer 2 + 1 data source Layer 2 + 1 generated _catalog.g.dart)',
        () async {
      ...
      try {
        ...
        // 217 wrappers (216 resource Layer 2 + 1 data source Layer 2) plus
        // the generated static catalog `_catalog.g.dart` (one CatalogEntry
        // per wrapper) → 218 emitted .dart files.
        expect(files, hasLength(218));
