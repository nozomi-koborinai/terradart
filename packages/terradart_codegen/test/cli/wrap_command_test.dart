...
void main() {
  ...
  group('WrapCommand integration', () {
    test(
        'emits 238 files (236 resource Layer 2 + 1 data source Layer 2 + 1 generated _catalog.g.dart)',
        () async {
      ...
      try {
        ...
        // 237 wrappers (236 resource Layer 2 + 1 data source Layer 2) plus
        // the generated static catalog `_catalog.g.dart` (one CatalogEntry
        // per wrapper) → 238 emitted .dart files.
        expect(files, hasLength(238));
