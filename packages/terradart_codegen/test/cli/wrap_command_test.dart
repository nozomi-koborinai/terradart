...
void main() {
  ...
  group('WrapCommand integration', () {
    test(
        'emits 246 files (244 resource Layer 2 + 1 data source Layer 2 + 1 generated _catalog.g.dart)',
        () async {
      ...
      try {
        ...
        // 245 wrappers (244 resource Layer 2 + 1 data source Layer 2) plus
        // the generated static catalog `_catalog.g.dart` (one CatalogEntry
        // per wrapper) → 246 emitted .dart files.
        expect(files, hasLength(246));
