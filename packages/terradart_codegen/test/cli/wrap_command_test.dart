...
void main() {
  ...
  group('WrapCommand integration', () {
    test(
        'emits 1005 files (892 wrappers + _catalog.g.dart + 111 barrels + umbrella)',
        () async {
      ...
      try {
        ...
        // 892 wrappers (891 resource Layer 2 + 1 data source Layer 2) plus
        // the generated static catalog `_catalog.g.dart`, plus the derived
        // barrels: 111 per-catalog barrels (110 service + `data`) and the
        // `terradart_google.dart` umbrella → 1005 emitted .dart files.
        expect(files, hasLength(1005));
