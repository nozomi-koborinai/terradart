...
void main() {
  ...
  group('WrapCommand integration', () {
    test(
        'emits 221 files (219 resource Layer 2 + 1 data source Layer 2 + 1 generated _catalog.g.dart)',
        () async {
      ...
      try {
        ...
        // 220 wrappers (219 resource Layer 2 + 1 data source Layer 2) plus
        // the generated static catalog `_catalog.g.dart` (one CatalogEntry
        // per wrapper) → 221 emitted .dart files.
        expect(files, hasLength(221));
