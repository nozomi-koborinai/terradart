...
void main() {
  ...
  group('WrapCommand integration', () {
    test(
        'emits 1254 files (1135 wrappers + _catalog.g.dart + 117 barrels + umbrella)',
        () async {
      ...
      try {
        ...
        // 1135 wrappers (1134 resource Layer 2 + 1 data source Layer 2) plus
        // the generated static catalog `_catalog.g.dart`, plus the derived
        // barrels: 117 per-catalog barrels (116 service + `data`) and the
        // `terradart_google.dart` umbrella → 1254 emitted .dart files.
        expect(files, hasLength(1254));
