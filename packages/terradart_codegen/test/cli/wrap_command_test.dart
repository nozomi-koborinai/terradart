...
void main() {
  ...
  group('WrapCommand integration', () {
    test(
        'emits 225 files (223 resource Layer 2 + 1 data source Layer 2 + 1 generated _catalog.g.dart)',
        () async {
      ...
      try {
        ...
        // 224 wrappers (223 resource Layer 2 + 1 data source Layer 2) plus
        // the generated static catalog `_catalog.g.dart` (one CatalogEntry
        // per wrapper) → 225 emitted .dart files.
        expect(files, hasLength(225));
