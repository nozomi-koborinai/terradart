...
void main() {
  ...
  group('WrapCommand integration', () {
    test(
        'emits 558 files (474 wrappers + _catalog.g.dart + 82 barrels + umbrella)',
        () async {
      ...
      try {
        ...
        // 474 wrappers (473 resource Layer 2 + 1 data source Layer 2) plus
        // the generated static catalog `_catalog.g.dart`, plus the derived
        // barrels: 82 per-catalog barrels (81 service + `data`) and the
        // `terradart_google.dart` umbrella → 558 emitted .dart files.
        expect(files, hasLength(558));
