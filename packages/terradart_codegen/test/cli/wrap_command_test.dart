...
void main() {
  ...
  group('WrapCommand integration', () {
    test(
        'emits 275 files (273 resource Layer 2 + 1 data source Layer 2 + 1 generated _catalog.g.dart)',
        () async {
      ...
      try {
        ...
        // 274 wrappers (273 resource Layer 2 + 1 data source Layer 2) plus
        // the generated static catalog `_catalog.g.dart` (one CatalogEntry
        // per wrapper) → 275 emitted .dart files.
        expect(files, hasLength(275));
