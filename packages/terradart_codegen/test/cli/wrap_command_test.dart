...
void main() {
  ...
  group('WrapCommand integration', () {
    test(
        'emits 1260 files (1141 wrappers + _catalog.g.dart + 117 barrels + umbrella)',
        () async {
      ...
      try {
        ...
        // 1141 wrappers (1140 resource Layer 2 + 1 data source Layer 2) plus
        // the generated static catalog `_catalog.g.dart`, plus the derived
        // barrels: 117 per-catalog barrels (116 service + `data`) and the
        // `terradart_google.dart` umbrella → 1260 emitted .dart files.
        expect(files, hasLength(1260));
