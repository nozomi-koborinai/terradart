...
void main() {
  ...
  group('WrapCommand integration', () {
    test(
        'emits 138 files (136 resource Layer 2 + 1 data source Layer 2 + 1 generated _catalog.g.dart)',
        () async {
      ...
      try {
        ...
        // 137 wrappers (136 resource Layer 2 + 1 data source Layer 2) plus
        // the generated static catalog `_catalog.g.dart` (one CatalogEntry
        // per wrapper) → 138 emitted .dart files.
        expect(files, hasLength(138));
