...
void main() {
  ...
  group('WrapCommand integration', () {
    test(
        'emits 323 files (321 resource Layer 2 + 1 data source Layer 2 + 1 generated _catalog.g.dart)',
        () async {
      ...
      try {
        ...
        // 322 wrappers (321 resource Layer 2 + 1 data source Layer 2) plus
        // the generated static catalog `_catalog.g.dart` (one CatalogEntry
        // per wrapper) → 323 emitted .dart files.
        expect(files, hasLength(323));
