...
Curated GCP factory wrappers for [terradart](https://github.com/nozomi-koborinai/terradart). Ships **296 curated resource factories + 1 data source** (297 catalog entries) with typed enums, sealed nested blocks, and golden-tested deterministic codegen.
