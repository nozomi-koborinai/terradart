...
Curated GCP factory wrappers for [terradart](https://github.com/nozomi-koborinai/terradart). Ships **317 curated resource factories + 1 data source** (318 catalog entries) with typed enums, sealed nested blocks, and golden-tested deterministic codegen.
