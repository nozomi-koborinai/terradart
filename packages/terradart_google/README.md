...
Curated GCP factory wrappers for [terradart](https://github.com/nozomi-koborinai/terradart). Ships **136 curated resource factories + 1 data source** (137 catalog entries) with typed enums, sealed nested blocks, and golden-tested deterministic codegen.
