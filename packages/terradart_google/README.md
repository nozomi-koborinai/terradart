...
Curated GCP factory wrappers for [terradart](https://github.com/nozomi-koborinai/terradart). Ships **195 curated resource factories + 1 data source** (196 catalog entries) with typed enums, sealed nested blocks, and golden-tested deterministic codegen.
