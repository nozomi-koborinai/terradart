...
Curated GCP factory wrappers for [terradart](https://github.com/nozomi-koborinai/terradart). Ships **209 curated resource factories + 1 data source** (210 catalog entries) with typed enums, sealed nested blocks, and golden-tested deterministic codegen.
