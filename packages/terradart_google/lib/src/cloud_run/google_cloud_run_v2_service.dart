...
final class GoogleCloudRunV2Service extends Resource {
  ...
  /// Reference to the auto-assigned default URL (`https://...run.app`).
  ...
  /// Reference to `latest_ready_revision` (name of the latest revision
  /// that has been marked Ready).
  TfRef<String> get latestReadyRevision =>
      TfRef.attribute<String>(this, 'latest_ready_revision');

  /// Reference to `latest_created_revision` (name of the most recently
  /// created revision regardless of readiness).
