...
/// Sensitive field paths for `google_iap_web_iam_member`.
const Set<String> _googleIapWebIamMemberSensitive = <String>{};
...
final class GoogleIapWebIamMember extends Resource {
  ...
  @override
  Set<String> get sensitiveFields => _googleIapWebIamMemberSensitive;
