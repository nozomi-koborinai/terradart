...
/// Sensitive field paths for `google_iam_projects_policy_binding`.
const Set<String> _googleIamProjectsPolicyBindingSensitive = <String>{};

/// Typed helper for the `condition` block of
/// `google_iam_projects_policy_binding` (derived from provider schema).
@immutable
final class IamProjectsPolicyBindingCondition {
  const IamProjectsPolicyBindingCondition({
    this.description,
    this.expression,
    this.location,
    this.title,
...
/// `google_iam_projects_policy_binding` (derived from provider schema).
@immutable
final class IamProjectsPolicyBindingTarget {
  const IamProjectsPolicyBindingTarget({this.principalSet});
...
final class GoogleIamProjectsPolicyBinding extends Resource {
  ...
  GoogleIamProjectsPolicyBinding({
    ...
    IamProjectsPolicyBindingCondition? condition,
    required IamProjectsPolicyBindingTarget target,
    super.lifecycle,
    super.dependsOn,
  }) : super(
