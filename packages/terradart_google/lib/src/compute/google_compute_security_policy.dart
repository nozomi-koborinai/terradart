...
class ComputeSecurityPolicySecurityPolicyLayer7DdosDefenseConfig {
  ...
  Map<String, Object?> toArgMap() => {
    ...
    if (ruleVisibility != null) 'rule_visibility': ruleVisibility!.toTfJson(),
...
class ComputeSecurityPolicySecurityPolicyAdaptiveProtectionThresholdConfig {
  ...
  Map<String, Object?> toArgMap() => {
    ...
    if (autoDeployExpirationSec != null)
      'auto_deploy_expiration_sec': autoDeployExpirationSec!.toTfJson(),
    if (autoDeployImpactedBaselineThreshold != null)
      'auto_deploy_impacted_baseline_threshold':
          autoDeployImpactedBaselineThreshold!.toTfJson(),
    if (autoDeployLoadThreshold != null)
      'auto_deploy_load_threshold': autoDeployLoadThreshold!.toTfJson(),
    if (detectionAbsoluteQps != null)
      'detection_absolute_qps': detectionAbsoluteQps!.toTfJson(),
    if (detectionLoadThreshold != null)
      'detection_load_threshold': detectionLoadThreshold!.toTfJson(),
...
class ComputeSecurityPolicySecurityPolicyTrafficGranularityConfig {
  ...
  Map<String, Object?> toArgMap() => {
    ...
    if (enableEachUniqueValue != null)
      'enable_each_unique_value': enableEachUniqueValue!.toTfJson(),
