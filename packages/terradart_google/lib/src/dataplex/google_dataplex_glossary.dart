...
/// Sensitive field paths for `google_dataplex_glossary`.
const Set<String> _googleDataplexGlossarySensitive = <String>{};
...
final class GoogleDataplexGlossary extends Resource {
  ...
  @override
  Set<String> get sensitiveFields => _googleDataplexGlossarySensitive;
  ...
  /// Reference to `category_count` attribute.
  TfRef<num> get categoryCount => TfRef.attribute<num>(this, 'category_count');
