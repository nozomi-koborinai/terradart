...
/// Sensitive field paths for `google_network_security_intercept_deployment_group`.
const Set<String> _googleNetworkSecurityInterceptDeploymentGroupSensitive =
    <String>{};
...
///
/// Network Security **intercept deployment group** — global grouping for
/// OOB intercept deployments on a VPC network.
///
...
/// apply-smoke.
final class GoogleNetworkSecurityInterceptDeploymentGroup extends Resource {
  ...
  Set<String> get sensitiveFields =>
      _googleNetworkSecurityInterceptDeploymentGroupSensitive;
