...
///
/// Network Security **intercept endpoint group association** — associates
/// an OOB intercept endpoint group with a consumer VPC network.
///
...
/// apply-smoke.
final class GoogleNetworkSecurityInterceptEndpointGroupAssociation
    extends Resource {
