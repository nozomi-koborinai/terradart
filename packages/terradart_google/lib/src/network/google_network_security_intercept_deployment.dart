...
/// Sensitive field paths for `google_network_security_intercept_deployment`.
const Set<String> _googleNetworkSecurityInterceptDeploymentSensitive =
    <String>{};
...
///
/// Network Security **intercept deployment** — zonal Out-of-band (OOB)
/// intercept appliance bound to a forwarding rule and deployment group.
///
...
final class GoogleNetworkSecurityInterceptDeployment extends Resource {
  ...
  Set<String> get sensitiveFields =>
      _googleNetworkSecurityInterceptDeploymentSensitive;
