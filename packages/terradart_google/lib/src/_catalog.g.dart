...
const List<CatalogEntry> terradartCatalog = <CatalogEntry>[
  ...
  CatalogEntry(
    ...
    nestedTypes: <String>['BigqueryDatapolicyDataPolicyType'],
    sensitiveFields: <String>[],
  ...
  CatalogEntry(
    ...
    nestedTypes: <String>['CloudRunV2WorkerPoolLaunchStage'],
    sensitiveFields: <String>[],
  ...
  CatalogEntry(
    ...
    nestedTypes: <String>['RegionSecurityPolicyType'],
    sensitiveFields: <String>[],
  ...
  CatalogEntry(
    ...
    nestedTypes: <String>['DnsRecordSetType'],
    sensitiveFields: <String>[],
