...
part of 'google_cloudfunctions2_function_iam_member.schema.dart';
...
base class GoogleCloudfunctions2FunctionIamMember {
  /// Creates a [GoogleCloudfunctions2FunctionIamMember] from a JSON map.
  factory GoogleCloudfunctions2FunctionIamMember.fromJson(
    Map<String, dynamic> json,
  ) => $schema.parse(json);

  GoogleCloudfunctions2FunctionIamMember._(this._json);
  ...
  /// The JSON schema and type descriptor for [GoogleCloudfunctions2FunctionIamMember].
  static const SchemanticType<GoogleCloudfunctions2FunctionIamMember> $schema =
      _GoogleCloudfunctions2FunctionIamMemberTypeFactory();

  String get cloudFunction {
    return _json['cloud_function'] as String;
  }

  set cloudFunction(String value) {
    _json['cloud_function'] = value;
  }
  ...
  /// Serializes this [GoogleCloudfunctions2FunctionIamMember] to a JSON map.
  Map<String, dynamic> toJson() {
    return _json;
  }
}

base class _GoogleCloudfunctions2FunctionIamMemberTypeFactory
    extends SchemanticType<GoogleCloudfunctions2FunctionIamMember> {
  const _GoogleCloudfunctions2FunctionIamMemberTypeFactory();

  @override
  GoogleCloudfunctions2FunctionIamMember parse(Object? json) {
    return GoogleCloudfunctions2FunctionIamMember._(
  ...
  JsonSchemaMetadata get schemaMetadata => JsonSchemaMetadata(
    ...
    definition: $Schema
        .object(
          ...
          required: ['cloud_function', 'member', 'role'],
        )
        .value,
