...
// Source: hashicorp/google v7.31.0 -- google_bigquery_table
import 'package:schemantic/schemantic.dart';
import 'package:terradart_annotations/terradart_annotations.dart';

part 'google_bigquery_table.schema.g.dart';

@Schema(description: 'Specifies the configuration of a BigLake managed table.')
abstract class $BiglakeConfiguration {
  @StringField(
    name: 'connection_id',
    description:
...
@Schema(description: 'Serializer and deserializer information.')
abstract class $SerdeInfo {
  @StringField(
...
abstract class $StorageDescriptor {
  @StringField(
    name: 'input_format',
    description:
  ...
  @Field(name: 'serde_info')
  $SerdeInfo? get serdeInfo;
}

@Schema(description: 'Options defining open source compatible table.')
abstract class $ExternalCatalogTableOptions {
  @StringField(
    name: 'connection_id',
    description:
  ...
  @Field(name: 'storage_descriptor')
  $StorageDescriptor? get storageDescriptor;
}

@Schema(description: 'Additional options if source_format is set to "AVRO"')
abstract class $AvroOptions {
  @Field(
...
abstract class $Column {
  ...
  @StringField(name: 'qualifier_string', description: 'Qualifier string.')
...
@Schema(description: 'Additional options if sourceFormat is set to BIGTABLE.')
abstract class $BigtableOptions {
  @Field(
    name: 'ignore_unspecified_column_families',
    description:
  ...
  @Field(
    name: 'output_column_families_as_json',
    description:
...
abstract class $GoogleSheetsOptions {
  @StringField(
    description:
...
abstract class $HivePartitioningOptions {
  @StringField(
    description:
...
abstract class $ExternalDataConfiguration {
  @Field(
    description:
  ...
  @StringField(
    name: 'reference_file_schema_uri',
    description:
...
abstract class $MaterializedView {
  @Field(
    name: 'allow_non_incremental_definition',
    description:
  ...
  @StringField(description: 'A query whose result is persisted.')
  String get query;
...
abstract class $Range {
  @Field(description: 'End of the range partitioning, exclusive.')
  num get end;

  @Field(description: 'The width of each range within the partition.')
  num get interval;

  @Field(description: 'Start of the range partitioning, inclusive.')
  num get start;
}
...
abstract class $RangePartitioning {
  @StringField(
    description:
...
abstract class $SchemaForeignTypeInfo {
  @StringField(
    name: 'type_system',
...
abstract class $ColumnReferences {
  @StringField(
...
abstract class $ReferencedTable {
  @StringField(
    name: 'dataset_id',
...
abstract class $ForeignKeys {
  @StringField(description: 'Set only if the foreign key constraint is named.')
  String? get name;

  @Field(name: 'column_references')
...
@Schema(description: 'Defines the primary key and foreign keys.')
abstract class $TableConstraints {
...
abstract class $TableReplicationInfo {
  @Field(
...
abstract class $TimePartitioning {
  /// Optional + Computed. Inferred from provider when null.
  @Field(
    name: 'expiration_ms',
    description:
...
@Schema(description: 'If specified, configures this table as a view.')
abstract class $View {
  @StringField(
...
@TerraformResource(type: 'google_bigquery_table', provider: 'hashicorp/google')
@Schema()
abstract class $GoogleBigqueryTable {
  @Field(
    description:
  ...
  @StringField(description: 'The field description.')
  ...
  /// Optional + Computed. Inferred from provider when null.
  @StringField(description: 'A JSON schema for the table.')
  String? get schema;
...
const Set<String> googleBigqueryTableSensitive = <String>{};
