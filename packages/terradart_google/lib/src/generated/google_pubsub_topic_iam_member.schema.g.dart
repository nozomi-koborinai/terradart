...
part of 'google_pubsub_topic_iam_member.schema.dart';
...
base class GooglePubsubTopicIamMember {
  /// Creates a [GooglePubsubTopicIamMember] from a JSON map.
  factory GooglePubsubTopicIamMember.fromJson(Map<String, dynamic> json) =>
      $schema.parse(json);

  GooglePubsubTopicIamMember._(this._json);
  ...
  /// The JSON schema and type descriptor for [GooglePubsubTopicIamMember].
  static const SchemanticType<GooglePubsubTopicIamMember> $schema =
      _GooglePubsubTopicIamMemberTypeFactory();
  ...
  /// Serializes this [GooglePubsubTopicIamMember] to a JSON map.
  Map<String, dynamic> toJson() {
    return _json;
  }
}

base class _GooglePubsubTopicIamMemberTypeFactory
    extends SchemanticType<GooglePubsubTopicIamMember> {
  const _GooglePubsubTopicIamMemberTypeFactory();

  @override
  GooglePubsubTopicIamMember parse(Object? json) {
    return GooglePubsubTopicIamMember._(json as Map<String, dynamic>);
  }
