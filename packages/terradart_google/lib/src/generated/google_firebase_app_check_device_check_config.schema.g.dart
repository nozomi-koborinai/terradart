...
part of 'google_firebase_app_check_device_check_config.schema.dart';
...
base class GoogleFirebaseAppCheckDeviceCheckConfig {
  /// Creates a [GoogleFirebaseAppCheckDeviceCheckConfig] from a JSON map.
  factory GoogleFirebaseAppCheckDeviceCheckConfig.fromJson(
    Map<String, dynamic> json,
  ) => $schema.parse(json);

  GoogleFirebaseAppCheckDeviceCheckConfig._(this._json);
  ...
  /// The JSON schema and type descriptor for [GoogleFirebaseAppCheckDeviceCheckConfig].
  static const SchemanticType<GoogleFirebaseAppCheckDeviceCheckConfig> $schema =
      _GoogleFirebaseAppCheckDeviceCheckConfigTypeFactory();
  ...
  String get privateKey {
    return _json['private_key'] as String;
  }

  set privateKey(String value) {
    _json['private_key'] = value;
  }
  ...
  /// Serializes this [GoogleFirebaseAppCheckDeviceCheckConfig] to a JSON map.
  Map<String, dynamic> toJson() {
    return _json;
  }
}

base class _GoogleFirebaseAppCheckDeviceCheckConfigTypeFactory
    extends SchemanticType<GoogleFirebaseAppCheckDeviceCheckConfig> {
  const _GoogleFirebaseAppCheckDeviceCheckConfigTypeFactory();

  @override
  GoogleFirebaseAppCheckDeviceCheckConfig parse(Object? json) {
    return GoogleFirebaseAppCheckDeviceCheckConfig._(
  ...
  @override
  JsonSchemaMetadata get schemaMetadata => JsonSchemaMetadata(
    name: 'GoogleFirebaseAppCheckDeviceCheckConfig',
    definition: $Schema
        .object(
          properties: {
          ...
          required: ['app_id', 'key_id', 'private_key'],
        )
        .value,
