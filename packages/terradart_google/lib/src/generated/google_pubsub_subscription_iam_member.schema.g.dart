...
part of 'google_pubsub_subscription_iam_member.schema.dart';
...
base class GooglePubsubSubscriptionIamMember {
  /// Creates a [GooglePubsubSubscriptionIamMember] from a JSON map.
  factory GooglePubsubSubscriptionIamMember.fromJson(
    Map<String, dynamic> json,
  ) => $schema.parse(json);

  GooglePubsubSubscriptionIamMember._(this._json);
  ...
  /// The JSON schema and type descriptor for [GooglePubsubSubscriptionIamMember].
  static const SchemanticType<GooglePubsubSubscriptionIamMember> $schema =
      _GooglePubsubSubscriptionIamMemberTypeFactory();
  ...
  String get subscription {
    return _json['subscription'] as String;
  }

  set subscription(String value) {
    _json['subscription'] = value;
  }
  ...
  /// Serializes this [GooglePubsubSubscriptionIamMember] to a JSON map.
  Map<String, dynamic> toJson() {
    return _json;
  }
}

base class _GooglePubsubSubscriptionIamMemberTypeFactory
    extends SchemanticType<GooglePubsubSubscriptionIamMember> {
  const _GooglePubsubSubscriptionIamMemberTypeFactory();

  @override
  GooglePubsubSubscriptionIamMember parse(Object? json) {
    return GooglePubsubSubscriptionIamMember._(json as Map<String, dynamic>);
  }
  ...
  JsonSchemaMetadata get schemaMetadata => JsonSchemaMetadata(
    ...
    definition: $Schema
        .object(
          ...
          required: ['member', 'role', 'subscription'],
        )
        .value,
