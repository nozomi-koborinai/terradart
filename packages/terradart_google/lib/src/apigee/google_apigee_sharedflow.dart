...
/// Sensitive field paths for `google_apigee_sharedflow`.
const Set<String> _googleApigeeSharedflowSensitive = <String>{};

/// Factory wrapper for `google_apigee_sharedflow`.
///
/// Apigee **shared flow** — uploads a shared-flow config bundle into an
/// organization.
///
