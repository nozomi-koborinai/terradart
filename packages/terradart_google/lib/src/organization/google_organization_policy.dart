...
/// Sensitive field paths for `google_organization_policy`.
const Set<String> _googleOrganizationPolicySensitive = <String>{};

/// Typed helper for the `boolean_policy` block of
/// `google_organization_policy` (derived from provider schema).
@immutable
final class OrganizationPolicyBooleanPolicy {
  const OrganizationPolicyBooleanPolicy({required this.enforced});
...
/// `google_organization_policy` (derived from provider schema).
@immutable
final class OrganizationPolicyListPolicy {
...
/// `google_organization_policy` (derived from provider schema).
@immutable
final class OrganizationPolicyListPolicyAllow {
  const OrganizationPolicyListPolicyAllow({this.all, this.values});
...
/// `google_organization_policy` (derived from provider schema).
@immutable
final class OrganizationPolicyListPolicyDeny {
  const OrganizationPolicyListPolicyDeny({this.all, this.values});
...
/// `google_organization_policy` (derived from provider schema).
@immutable
final class OrganizationPolicyRestorePolicy {
  const OrganizationPolicyRestorePolicy({required this.defaultCase});
...
final class GoogleOrganizationPolicy extends Resource {
  ...
  @override
  Set<String> get sensitiveFields => _googleOrganizationPolicySensitive;
