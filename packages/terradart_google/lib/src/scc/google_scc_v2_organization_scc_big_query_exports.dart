...
/// Sensitive field paths for `google_scc_v2_organization_scc_big_query_exports`.
const Set<String> _googleSccV2OrganizationSccBigQueryExportsSensitive =
    <String>{};
...
///
/// SCC v2 organization BigQuery exports (bulk) — leftover factory on the
/// apply-excluded path (synth + `terraform validate` only).
///
/// Needs an organization / folder / external artifact that
/// standalone terradart-validate cannot supply. Do not apply.
final class GoogleSccV2OrganizationSccBigQueryExports extends Resource {
