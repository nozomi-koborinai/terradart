...
/// Sensitive field paths for `google_scc_v2_organization_scc_big_query_export`.
const Set<String> _googleSccV2OrganizationSccBigQueryExportSensitive =
    <String>{};
...
///
/// SCC v2 organization BigQuery export — leftover factory on the
/// apply-excluded path (synth + `terraform validate` only).
///
/// Needs an organization / folder / external artifact that
/// standalone terradart-validate cannot supply. Do not apply.
final class GoogleSccV2OrganizationSccBigQueryExport extends Resource {
