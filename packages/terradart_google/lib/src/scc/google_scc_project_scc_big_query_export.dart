...
/// Sensitive field paths for `google_scc_project_scc_big_query_export`.
const Set<String> _googleSccProjectSccBigQueryExportSensitive = <String>{};
...
///
/// SCC project BigQuery export — leftover factory on the
...
final class GoogleSccProjectSccBigQueryExport extends Resource {
  ...
  Set<String> get sensitiveFields =>
      _googleSccProjectSccBigQueryExportSensitive;
