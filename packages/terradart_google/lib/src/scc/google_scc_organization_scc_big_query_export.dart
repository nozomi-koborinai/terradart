...
/// Sensitive field paths for `google_scc_organization_scc_big_query_export`.
const Set<String> _googleSccOrganizationSccBigQueryExportSensitive = <String>{};
...
///
/// SCC organization BigQuery export — leftover factory on the
