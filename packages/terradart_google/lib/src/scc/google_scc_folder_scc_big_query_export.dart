...
/// Sensitive field paths for `google_scc_folder_scc_big_query_export`.
const Set<String> _googleSccFolderSccBigQueryExportSensitive = <String>{};
...
/// findings, and security marks to a BigQuery instance.
///
...
///
/// SCC folder BigQuery export — leftover factory on the
...
final class GoogleSccFolderSccBigQueryExport extends Resource {
  ...
  @override
  Set<String> get sensitiveFields => _googleSccFolderSccBigQueryExportSensitive;
