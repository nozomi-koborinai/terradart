...
/// Sensitive field paths for `google_vmwareengine_nsx_credentials`.
const Set<String> _googleVmwareengineNsxCredentialsSensitive = <String>{};
...
final class DataGoogleVmwareengineNsxCredentials extends Data {
  ...
  @override
  Set<String> get sensitiveFields => _googleVmwareengineNsxCredentialsSensitive;
