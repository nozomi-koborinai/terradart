...
/// Sensitive field paths for `google_container_aws_versions`.
const Set<String> _googleContainerAwsVersionsSensitive = <String>{};
...
final class DataGoogleContainerAwsVersions extends Data {
  ...
  @override
  Set<String> get sensitiveFields => _googleContainerAwsVersionsSensitive;
