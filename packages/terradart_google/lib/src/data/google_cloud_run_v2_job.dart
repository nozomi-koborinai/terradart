...
final class DataGoogleCloudRunV2Job extends Data {
  ...
  /// Reference to `execution_count` attribute.
  TfRef<num> get executionCount =>
      TfRef.attribute<num>(this, 'execution_count');
  ...
  /// Reference to `latest_created_execution` attribute.
  TfRef<List<Map<String, Object?>>> get latestCreatedExecution =>
