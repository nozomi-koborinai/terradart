...
/// `aws_ami_copy` (derived from provider schema).
@immutable
...
/// Factory wrapper for `aws_ami_copy`.
final class AwsAmiCopy extends Resource {
  ...
  AwsAmiCopy({
    ...
    required TfArg<String> sourceAmiRegion,
    TfArg<Map<String, String>>? tags,
    List<AmiCopyEbsBlockDevice>? ebsBlockDevice,
    List<AmiCopyEphemeralBlockDevice>? ephemeralBlockDevice,
    super.lifecycle,
    super.dependsOn,
    super.provider,
    super.timeouts,
  ...
  @override
  Set<String> get sensitiveFields => _awsAmiCopySensitive;
