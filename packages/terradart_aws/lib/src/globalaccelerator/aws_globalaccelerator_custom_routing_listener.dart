...
/// Sensitive field paths for `aws_globalaccelerator_custom_routing_listener`.
const Set<String> _awsGlobalacceleratorCustomRoutingListenerSensitive =
    <String>{};

/// Typed helper for the `port_range` block of
/// `aws_globalaccelerator_custom_routing_listener` (derived from provider schema).
@immutable
final class GlobalacceleratorCustomRoutingListenerPortRange {
  const GlobalacceleratorCustomRoutingListenerPortRange({
    this.fromPort,
    this.toPort,
  });
...
/// Factory wrapper for `aws_globalaccelerator_custom_routing_listener`.
