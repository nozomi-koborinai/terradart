...
/// Sensitive field paths for `aws_media_store_container`.
const Set<String> _awsMediaStoreContainerSensitive = <String>{};

/// Factory wrapper for `aws_media_store_container`.
