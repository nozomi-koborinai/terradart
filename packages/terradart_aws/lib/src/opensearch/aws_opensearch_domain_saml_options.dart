...
/// Sensitive field paths for `aws_opensearch_domain_saml_options`.
const Set<String> _awsOpensearchDomainSamlOptionsSensitive = <String>{
...
/// Factory wrapper for `aws_opensearch_domain_saml_options`.
final class AwsOpensearchDomainSamlOptions extends Resource {
  ...
  @override
  Set<String> get sensitiveFields => _awsOpensearchDomainSamlOptionsSensitive;
