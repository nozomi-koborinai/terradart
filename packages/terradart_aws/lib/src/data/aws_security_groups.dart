...
/// Sensitive field paths for `aws_security_groups`.
const Set<String> _awsSecurityGroupsSensitive = <String>{};

/// Typed helper for the `filter` block of
/// `aws_security_groups` (derived from provider schema).
@immutable
final class DataSecurityGroupsFilter {
  const DataSecurityGroupsFilter({required this.name, required this.values});
...
/// Factory wrapper for `aws_security_groups`.
final class DataAwsSecurityGroups extends Data {
  ...
  @override
  Set<String> get sensitiveFields => _awsSecurityGroupsSensitive;
