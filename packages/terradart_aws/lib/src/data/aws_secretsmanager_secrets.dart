...
/// Sensitive field paths for `aws_secretsmanager_secrets`.
const Set<String> _awsSecretsmanagerSecretsSensitive = <String>{};

/// Typed helper for the `filter` block of
/// `aws_secretsmanager_secrets` (derived from provider schema).
@immutable
final class DataSecretsmanagerSecretsFilter {
  const DataSecretsmanagerSecretsFilter({
    required this.name,
...
/// Factory wrapper for `aws_secretsmanager_secrets`.
final class DataAwsSecretsmanagerSecrets extends Data {
  ...
  @override
  Set<String> get sensitiveFields => _awsSecretsmanagerSecretsSensitive;
