...
/// Sensitive field paths for `aws_s3_objects`.
const Set<String> _awsS3ObjectsSensitive = <String>{};

/// Factory wrapper for `aws_s3_objects`.
final class DataAwsS3Objects extends Data {
  ...
  @override
  Set<String> get sensitiveFields => _awsS3ObjectsSensitive;
  ...
  TfRef<String> get requestCharged =>
