...
/// Sensitive field paths for `aws_securityhub_account_v2`.
const Set<String> _awsSecurityhubAccountV2Sensitive = <String>{};

/// Factory wrapper for `aws_securityhub_account_v2`.
