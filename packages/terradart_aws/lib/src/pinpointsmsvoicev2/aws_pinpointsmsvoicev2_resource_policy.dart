...
/// Sensitive field paths for `aws_pinpointsmsvoicev2_resource_policy`.
const Set<String> _awsPinpointsmsvoicev2ResourcePolicySensitive = <String>{};

/// Factory wrapper for `aws_pinpointsmsvoicev2_resource_policy`.
