...
/// Sensitive field paths for `aws_pinpointsmsvoicev2_opt_out_list`.
const Set<String> _awsPinpointsmsvoicev2OptOutListSensitive = <String>{};

/// Factory wrapper for `aws_pinpointsmsvoicev2_opt_out_list`.
