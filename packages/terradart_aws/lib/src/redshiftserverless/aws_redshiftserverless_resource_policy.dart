...
/// Sensitive field paths for `aws_redshiftserverless_resource_policy`.
const Set<String> _awsRedshiftserverlessResourcePolicySensitive = <String>{};

/// Factory wrapper for `aws_redshiftserverless_resource_policy`.
