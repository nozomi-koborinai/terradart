...
/// Sensitive field paths for `aws_pinpoint_apns_sandbox_channel`.
const Set<String> _awsPinpointApnsSandboxChannelSensitive = <String>{
  'bundle_id',
  'certificate',
  'private_key',
  'team_id',
...
/// Factory wrapper for `aws_pinpoint_apns_sandbox_channel`.
final class AwsPinpointApnsSandboxChannel extends Resource {
  ...
  @override
  Set<String> get sensitiveFields => _awsPinpointApnsSandboxChannelSensitive;
