...
/// Sensitive field paths for `aws_pinpoint_apns_voip_channel`.
const Set<String> _awsPinpointApnsVoipChannelSensitive = <String>{
  'bundle_id',
  'certificate',
  'private_key',
  'team_id',
...
/// Factory wrapper for `aws_pinpoint_apns_voip_channel`.
final class AwsPinpointApnsVoipChannel extends Resource {
  ...
  @override
  Set<String> get sensitiveFields => _awsPinpointApnsVoipChannelSensitive;
