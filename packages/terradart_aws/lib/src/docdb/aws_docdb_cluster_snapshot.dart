...
/// Sensitive field paths for `aws_docdb_cluster_snapshot`.
const Set<String> _awsDocdbClusterSnapshotSensitive = <String>{};

/// Factory wrapper for `aws_docdb_cluster_snapshot`.
final class AwsDocdbClusterSnapshot extends Resource {
  ...
  @override
  Set<String> get sensitiveFields => _awsDocdbClusterSnapshotSensitive;
