...
/// Sensitive field paths for `aws_wafregional_size_constraint_set`.
const Set<String> _awsWafregionalSizeConstraintSetSensitive = <String>{};

/// Typed helper for the `size_constraints` block of
/// `aws_wafregional_size_constraint_set` (derived from provider schema).
@immutable
final class WafregionalSizeConstraintSetSizeConstraints {
  const WafregionalSizeConstraintSetSizeConstraints({
...
/// Factory wrapper for `aws_wafregional_size_constraint_set`.
final class AwsWafregionalSizeConstraintSet extends Resource {
  ...
  @override
  Set<String> get sensitiveFields => _awsWafregionalSizeConstraintSetSensitive;
