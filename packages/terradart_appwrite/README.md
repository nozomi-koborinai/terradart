...
Curated surface is the full `appwrite/appwrite` `2.0.0-beta.1` catalog: 38 resource factories and 24 data sources across project, proxy, TablesDB, dedicated PostgreSQL / MySQL / Mongo, storage, auth, functions, sites, messaging, webhooks, and backups. Provider pinned exactly at `2.0.0-beta.1` (the provider is beta-maturity).
