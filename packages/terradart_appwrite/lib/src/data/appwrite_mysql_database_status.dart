...
/// Sensitive field paths for `appwrite_mysql_database_status`.
const Set<String> _appwriteMysqlDatabaseStatusSensitive = <String>{};
...
final class DataAppwriteMysqlDatabaseStatus extends Data {
  ...
  @override
  Set<String> get sensitiveFields => _appwriteMysqlDatabaseStatusSensitive;
