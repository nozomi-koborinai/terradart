...
|------|---------|--------------------|
| Schema bump | Sundays 22:00 UTC ([`schema-bump.yml`](.github/workflows/schema-bump.yml)) | Monday-morning agent ([runbook](.cursor/agents/schema-bump-postprocess.md)) → [`bump-merge.yml`](.github/workflows/bump-merge.yml) executor, gated by `BUMP_MERGE_ENABLED` |
