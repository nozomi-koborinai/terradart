...
- `terradart_migrate` for the HCL → Dart migrator itself: today the four generated migration manifests (`googleMigrateManifest`, ...) and their runtime types; the emitter and the `terradart-migrate` CLI follow (#660, #661).
